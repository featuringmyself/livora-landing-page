  ...
  return (
    <section id="waitlist" className="py-16 md:py-24 bg-gradient-to-br from-green-600 via-emerald-700 to-green-800 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute top-1/2 left-1/3 w-8 h-8 bg-white rounded-full animate-float" style={{ animationDelay: '1.5s' }}></div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-4 text-center relative z-10">
        <div ref={sectionRef}>
          <div className="inline-flex items-center justify-center w-16 h-16 bg-white/20 backdrop-blur-sm rounded-2xl mb-6 animate-float shadow-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center group cursor-pointer">
              <div className="inline-flex items-center justify-center w-14 h-14 bg-white/20 backdrop-blur-sm rounded-2xl mb-4 group-hover:scale-110 transition-transform duration-300 animate-float shadow-lg">
