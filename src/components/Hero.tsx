  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-50 flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-10 left-4 md:left-20 w-32 md:w-72 h-32 md:h-72 bg-gradient-to-r from-green-200/30 to-emerald-300/30 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-20 right-2 md:right-10 w-48 md:w-96 h-48 md:h-96 bg-gradient-to-r from-blue-200/20 to-purple-300/20 rounded-full blur-3xl animate-pulse delay-1000"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-40 md:w-80 h-40 md:h-80 bg-gradient-to-r from-yellow-200/20 to-orange-300/20 rounded-full blur-3xl animate-pulse delay-500"></div>
      </div>
      ...
      <div className="max-w-6xl mx-auto text-center relative z-10 px-4">
        <div className="animate-fade-in">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-8xl font-black text-gray-900 mb-6 md:mb-8 leading-tight">
            Meet{" "}
          ...
          <div className="flex flex-col sm:flex-row gap-4 md:gap-6 justify-center items-center mb-16 md:mb-20 px-4">
            <Button 
              ...
              className="w-full sm:w-auto bg-gradient-to-r from-green-500 via-emerald-500 to-green-600 hover:from-green-600 hover:via-emerald-600 hover:to-green-700 text-white px-6 md:px-10 py-4 md:py-6 text-lg md:text-xl rounded-2xl shadow-2xl hover:shadow-green-300/50 transform transition-all duration-300 group border-2 border-green-400/30"
            >
              <Heart className="w-5 md:w-6 h-5 md:h-6 mr-2 md:mr-3 group-hover:animate-pulse" />
              Join the Waitlist
              <Sparkles className="w-4 md:w-5 h-4 md:h-5 ml-2 md:ml-3 group-hover:animate-spin" />
            </Button>
            <Button 
              variant="outline" 
          ...
          <div className="flex flex-col sm:flex-row flex-wrap justify-center items-center gap-4 md:gap-8 text-sm md:text-lg text-gray-600 mb-8 md:mb-12 px-4">
            <div className="flex items-center group hover:scale-105 transition-transform">
              <div className="w-3 md:w-4 h-3 md:h-4 bg-gradient-to-r from-green-400 to-green-600 rounded-full mr-2 md:mr-3 animate-pulse shadow-lg"></div>
              <span className="font-semibold">AI-Powered Nutrition</span>
            </div>
            <div className="flex items-center group hover:scale-105 transition-transform">
              <div className="w-3 md:w-4 h-3 md:h-4 bg-gradient-to-r from-blue-400 to-blue-600 rounded-full mr-2 md:mr-3 animate-pulse shadow-lg"></div>
              <span className="font-semibold">Doctor Reviewed</span>
            </div>
            <div className="flex items-center group hover:scale-105 transition-transform">
              <div className="w-3 md:w-4 h-3 md:h-4 bg-gradient-to-r from-purple-400 to-purple-600 rounded-full mr-2 md:mr-3 animate-pulse shadow-lg"></div>
